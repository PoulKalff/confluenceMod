...
from db_class_mysql import HandleDB		# for mysql
#from db_class_postgres import HandleDB		# for postgresql
#from db_class import HandleDB			# for psqlite
...
#sys.exit('All well till here')
#programIndexes = [{'Title': 'A', 'Source': 'https://www.dr.dk/mu-online/api/1.4/search/tv/programcards-latest-episode-with-asset/series-title-starts-with/a', 'TotalSize': 106, '_Param': 'a'}]
